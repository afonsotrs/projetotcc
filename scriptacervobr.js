 ...
 function recommendBooks() {
     const searchAuthor2 = document.getElementById("searchAuthor2").value.trim() || document.getElementById("customAuthor2").value.trim();
     const searchGenre2 = document.getElementById("searchGenre2").value.trim();
     const searchLanguage = "pt"; // Consulta apenas em português
     const recommendationQuantity2 = document.getElementById("recommendationQuantity2").value;

     if (searchAuthor2 === "" && document.getElementById("searchAuthor2").selectedIndex === 0) {
     ...
     if (searchAuthor2 !== '') {
         searchTerm = `inauthor:${searchAuthor2}`;
     } else if (searchGenre2 !== '') {
         searchTerm = `subject:${searchGenre2}`;
     } else {
     ...
     fetch(url)
         ...
         .then(data => {
             ...
             allBooks2 = data.items || [];
             document.getElementById("results2").innerHTML = "";
             displayRandomResults(recommendationQuantity2);
         })
 ...
 function displayRandomResults(quantity) {
     ...
     while (uniqueBooks.size < quantity && allBooks2.length > 0) {
         const randomIndex = Math.floor(Math.random() * allBooks2.length);
         const book = allBooks2.splice(randomIndex, 1)[0];
     ...
     document.getElementById("results2").innerHTML = [...uniqueBooks].join('');
 }
 ...
 function searchMoreBooksByAuthor(authorName) {
     ...
     fetch(url)
         ...
         .then(data => {
             ...
             document.getElementById("results2").innerHTML = authorBooksHTML;
         })
 ...
 function searchAuthor() {
     ...
     if (customAuthor === "") {
         ...
         document.getElementById("searchAuthor2").value = customAuthor;
         recommendBooks();
     }
 }